...
$sql = $conn->prepare("INSERT INTO contacts (id,first_name, last_name,date_entered,phone_mobile,description,title)
            VALUES (:id, :first_name, :last_name,:date_entered, :phone_mobile, :phone_fax,:sem )");
...
<div class="container my-4 ">
    ...
    <form action="semregister.php" method="post">
